...
def custom_print(message, output_file="default_log.txt"):
    """
    Prints to the console and writes to the txt file also.

    :param message: Message 
    :param output_file: path to a file where log needs to be saved or defaults to default_log.txt in root
    """
    print(message)  # Print to the console
    if output_file:
        with open(output_file, 'a') as file:
            print(message, file=file)  # Write to the file